...
<div class="content-area py-1">
	<div class="container-fluid">
		...
		<ol class="breadcrumb no-bg mb-1">
			...
			<li class="breadcrumb-item"><a href="tables-datatable.html#">Games</a></li>
			<li class="breadcrumb-item active">Danh Sách Games</li>
		</ol>
		<div class="tab">
			<a href="${contextPath }/admin/games?status=active" ><button  class="tablinks ${param.status == 'active' ? 'active' : '' }" >
								...
								<c:forEach var="gl" items="${gameList}">
									<tr>
										...
										<td class="updateAndDelete"><a
											...
											onclick="deleteOne(${gl.gameId});" href="#"
