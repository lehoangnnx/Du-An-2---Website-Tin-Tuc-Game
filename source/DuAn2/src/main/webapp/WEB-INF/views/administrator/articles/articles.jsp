...
<div class="content-area py-1">
	<div class="container-fluid">
		...
		<ol class="breadcrumb no-bg mb-1">
			...
			<li class="breadcrumb-item"><a href="tables-datatable.html#">Bài Viết</a></li>
			<li class="breadcrumb-item active">Danh Sách Bài Viết</li>
		</ol>
		<div class="tab">
			
			<a href="${contextPath }/admin/articles?status=active" ><button  class="tablinks ${param.status == 'active' ? 'active' : '' }" >
									...
									<tr>
										...
										<td>
											<div  class="float-xs-left mr-1">
												...
												<input onchange="updateStatus(${al.articleId });" id="idArticleCheckbox${al.articleId }"  
												name="checkBoxStatus" type="checkbox" class="js-switch" data-size="small"
												value="${al.articleId }"	data-color="#f44236" data-switchery="true"
