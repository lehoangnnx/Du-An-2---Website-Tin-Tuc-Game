...
<div class="content-area py-1">
	<div class="container-fluid">
		...
		<ol class="breadcrumb no-bg mb-1">
			...
			<li class="breadcrumb-item"><a href="tables-datatable.html#">Danh Mục Bài Viết</a></li>
		...
		<div id="showAllUsers" class="tabcontent" style="display: block;">
			<div class="box box-block bg-white">
				<h5 class="mb-1">Danh Sách Danh Mục Bài Viết</h5>
				...
				<div class="overflow-x-auto">
					...
					<div id="jqcc">
						<table class="table table-striped table-bordered dataTable"
							...
							<tbody>
								<c:forEach var="acl" items="${articleCategoriesList}">
									<tr>
										<td class="cbDeleteAll"><input type="checkbox"
											value="${acl.articleCategoryId}" name="cb" /></td>
										<td>${acl.name} </td>
										<td>${acl.slug} </td>
										<td>${acl.status} </td>
