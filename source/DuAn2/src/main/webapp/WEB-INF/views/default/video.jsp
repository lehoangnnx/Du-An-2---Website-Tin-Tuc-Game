                            ...
                            <div class="rvs-item-container">
                                <div class="rvs-item-stage">
                                    <c:forEach var="gacnvl" items="${getTop10ArticleCategoryNewVideoList}">
                                        ...
                                        <div class="rvs-item" style="background-image: url(${gacnvl.imagesThumbnail})">
                                            <p class="rvs-item-text">VIDEO_TITLE
                                                <small>by VIDEO_CREDITS</small>
                                            </p>
                                    ...
                                    <c:forEach var="gacnvl" items="${getTop10ArticleCategoryNewVideoList}">
                                        ...
                                        <a class="rvs-nav-item">
                                            <span class="rvs-nav-item-thumb"
                                                  style="background-image: url('${contextPath}/images/articles/${gacnvl.imagesThumbnail}')"></span>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-4">
                            <div class="box">
                                <div class="title">
                                    <h2>
                                        <a style="color: white;" href="${contextPath}/game-mobile?sorted=news">Game
                                            mobile</a>
                                    </h2>
                                </div>
                                <ul>
