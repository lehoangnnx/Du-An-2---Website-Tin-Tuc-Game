...
<script>
    ...
    function replysubcomment(subCommentId,usersBySubUserId){
        console.log(subCommentId +"--"+ usersBySubUserId +"-");
    ...
    $('.btn-postcomment').click(function(){
        ...
        timeout = setTimeout(function () {
            ...
            $.ajax({
                ...
                data: {subCommentId:subCommentId,articleId:articleId,content:content},
                //dataType: 'json',
                // timeout: 600000,
                success: function (result) {
                    $("#LoadingImage").hide();
