...
<!-- Vendor JS -->
		...
		<script type="text/javascript" src="${contextPath}/js/sparkline/jquery.sparkline.min.js"></script>
		<script type="text/javascript" src="${contextPath}/js/raphael/raphael.min.js"></script>
		<script type="text/javascript" src="${contextPath}/js/morris/morris.min.js"></script>
